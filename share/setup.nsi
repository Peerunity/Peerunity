...
!define MUI_FINISHPAGE_RUN $INSTDIR\peerunity-qt.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/peerunity-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/peerunityd.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\PPCoin.lnk" $INSTDIR\peerunity-qt.exe
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\peerunity-qt.exe
